...
public class ApproveCellLib extends DefaultCellLib {
	...
	public static final String ICON_PALETTE_SUBPROCESS =PATH_ICON+"activity/expanded.subprocess"+PNG_SUFFIX;	
	...
	public static final String ICON_PALETTE_EVENT_SUPPROCESS =PATH_ICON+"activity/event.subprocess"+PNG_SUFFIX;	
	//Start Event
	...
	private String[][] shapeCells =new String[][]{new String[]
	                                                         ...
	                                                         {"Mail Task",ICON_PALETTE_MAILTASK, "shape=task;"+COLOR_TASK+"image="+ICON_PALETTE_MAILTASK+STYLE_DEFAULT+";shadow=1;rounded=1", "90", "55", "uap.workflow.bpmn2.model.MailTask","", "Y" ,NOTATION_ACTIVITY},
	                                                 		...
	                                                 		{"Sub-Process",ICON_PALETTE_SUBPROCESS,"shape=task;"+COLOR_CONTAINER+"image="+ICON_PALETTE_SUBPROCESS+STYLE_PROCESS,"360", "240", "uap.workflow.bpmn2.model.SubProcess","", "Y", NOTATION_ACTIVITY},
	                                                 		...
	                                                 		{"Event Subprocess",ICON_PALETTE_EVENT_SUPPROCESS,"shape=task;"+COLOR_CONTAINER+"dashed=true;image="+ICON_PALETTE_EVENT_SUPPROCESS+STYLE_PROCESS,"320", "220", "uap.workflow.bpmn2.model.SubProcess","", "Y", NOTATION_ACTIVITY},
	                                                 		...
	                                                 		{"Process",ICON_PALETTE_SWIMLANE_POOL, "shape=swimShape;"+LABELCOLOR_SWIM+"horizontal=false"+FILLCOLOR_SWIM+STYLE_POOL+";spacingTop=10;","300", "180", "uap.workflow.bpmn2.model.Pool","", "Y", NOTATION_ARTIFACTS},
	                                                 		{"Participant",ICON_PALETTE_SWIMLANE_LANE, "shape=swimShape;"+LABELCOLOR_SWIM+"horizontal=false"+FILLCOLOR_SWIM+STYLE_POOL+";spacingTop=10;","260", "180", "uap.workflow.bpmn2.model.Lane","", "Y", NOTATION_ARTIFACTS},
	                                                 		...
	                                                 		{"Sequence Flow",ICON_PALETTE_SEQUENCEFLOW_DEFAULT, "connector;startArrow=hadCondition;endArrow=block;strokeWidth=1.2"+FONT_TYPE, "100", "100", "uap.workflow.bpmn2.model.SequenceFlow","", "N", NOTATION_CONNECTION},
	                                                 		{"Message Flow",ICON_PALETTE_SEQUENCEFLOW_MESSAGEFLOW, "connector;dashed=true;dashPattern=10,2;startArrow=none;endArrow=block"+FONT_TYPE, "100", "100", "uap.workflow.bpmn2.model.MessageFlow","", "N", NOTATION_CONNECTION},
	                                                 		{"Association",ICON_PALETTE_SEQUENCEFLOW_ASSOCIATION, "connector;startArrow=none;dashed=true;dashPattern=2,4;endArrow=none"+FONT_TYPE, "100", "100", "uap.workflow.bpmn2.model.Association","", "N", NOTATION_CONNECTION},
	                                                 		{"Data Input Association",ICON_PALETTE_SEQUENCEFLOW_DATAASSOCIATIONINPUT, "connector;startArrow=none;dashed=true;dashPattern=2,2;endArrow=open"+FONT_TYPE, "100", "100", "uap.workflow.bpmn2.model.Association","", "N", NOTATION_CONNECTION},
	                                                 		{"Data Output Association",ICON_PALETTE_SEQUENCEFLOW_DATAASSOCIATIONINPUT, "connector;startArrow=none;dashed=true;dashPattern=2,2;endArrow=open"+FONT_TYPE, "100", "100", "uap.workflow.bpmn2.model.Association","", "N", NOTATION_CONNECTION}};
