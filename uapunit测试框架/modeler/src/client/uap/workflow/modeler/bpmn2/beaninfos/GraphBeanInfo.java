...
public class GraphBeanInfo extends SimpleBeanInfo {
	...
	public GraphBeanInfo(Class<?> type) {
		this.type = type;
	}
	...
	public BeanDescriptor getBeanDescriptor() {
		if (beanDescriptor == null) {
			beanDescriptor = new GraphBeanDescriptor(this);
		}
	 ...
	 * @return
	 */
	protected ExtendedGraphBeanDesriptor addProperty(String propertyName) {
		...
		try {
			...
			descriptor = ExtendedGraphBeanDesriptor.newPropertyDescriptor(propertyName, getType());

			try {
				// descriptor.setDisplayName(ResManager.getLanguageDependentString(propertyName));
				String str = propertyName;//NCLangResOnserver.getInstance().getStrByID("pfworkflow", propertyName);
