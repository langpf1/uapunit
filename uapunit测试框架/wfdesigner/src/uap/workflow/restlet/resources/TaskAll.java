...
public class TaskAll extends ServerResource {
	...
	public  JSONArray getTask(){ 
		...
		customers =TaskUtil.getTasks(TaskInstanceStatus.All.getIntValue(), null, null,currentparticipant.getParticipantID(), null, true,page);
