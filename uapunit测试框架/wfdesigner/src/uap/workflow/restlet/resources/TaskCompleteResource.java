...
public class TaskCompleteResource extends ServerResource {
	...
	public  JSONArray getTask(){
		...
		List<TaskInstanceVO> taskvolist = new ArrayList<TaskInstanceVO>();
		...
		taskvolist =TaskUtil.getTasks(TaskInstanceStatus.Finished.getIntValue(), null, null,currentparticipant.getParticipantID(), null, false,page);
		if(taskvolist != null){
			webtasklist = creattaskjson.creatWebTaskList(taskvolist);
		}
