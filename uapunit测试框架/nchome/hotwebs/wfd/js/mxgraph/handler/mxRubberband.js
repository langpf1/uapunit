...
mxRubberband.prototype.repaint = function()
{
	if (this.div != null)
	{
		...
		this.div.style.background="#3399FF";
		...
		{
          var height=this.graph.container.style.height.substring(0,this.graph.container.style.height.length-2);
          var scrollHeight=this.graph.container.scrollTop;
          this.div.style.left = (this.x) + 'px';
		  this.div.style.top = (this.y -height-scrollHeight) + 'px';
		}
	}
};
