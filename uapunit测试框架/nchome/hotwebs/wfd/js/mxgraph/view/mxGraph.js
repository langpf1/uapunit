 ...
 * Default value is "images/menuImages" + '/collapsed.gif'
 */
mxGraph.prototype.collapsedImage = new mxImage("images/menuImages"+ '/collapsed.gif', 9, 9);

/**
 * Variable: expandedImage
 * 
 * Specifies the <mxImage> to indicate a expanded state.
 * Default value is "images/menuImages" + '/expanded.gif'
 */
mxGraph.prototype.expandedImage = new mxImage("images/menuImages" + '/expanded.gif', 9, 9);

/**
 * Variable: warningImage
 * 
 * Specifies the <mxImage> for the image to be used to display a warning
 * overlay. See <setCellWarning>. Default value is "images/menuImages" +
 * '/warning'.  The extension for the image depends on the platform. It is
 * '.png' on the Mac and '.gif' on all other platforms.
 */
mxGraph.prototype.warningImage = new mxImage("images/menuImages" + '/warning'+
