...
Toolbar.prototype.init = function()
{
	...
	this.addItems(['-']);
	var _this=this;
	var cellAlign = this.addMenuFunction('horizontalLayout', mxResources.get('horizontalLayout'), true, function() {
	    ...
	    if (!graph.isSelectionEmpty())
			{
	    		...
	    		_this.editorUi.executeLayout(layout, true, true);
			} });
	var cellAlign = this.addMenuFunction('verticalLayout', mxResources.get('verticalLayout'), true, function() { 
			var graph = _this.editorUi.editor.graph;
			if (!graph.isSelectionEmpty())
			{
	...
	this.addItems(['-']);
	var cellAlign = this.addMenuFunction('leftAlign', mxResources.get('leftAlign'), true, function() { graph.alignCells(mxConstants.ALIGN_LEFT); });
	var cellAlign = this.addMenuFunction('centerAlign', mxResources.get('center'), true, function() { graph.alignCells(mxConstants.ALIGN_CENTER); });
	var cellAlign = this.addMenuFunction('rightAlign', mxResources.get('rightAlign'), true, function() { graph.alignCells(mxConstants.ALIGN_RIGHT); });
	this.addItems(['-']);
	var cellAlign = this.addMenuFunction('geSprite-top', mxResources.get('topAlign'), false, function() { graph.alignCells(mxConstants.ALIGN_TOP); });
	var cellAlign = this.addMenuFunction('geSprite-middle', mxResources.get('middleAlign'), false, function() { graph.alignCells(mxConstants.ALIGN_MIDDLE); } );
	var cellAlign = this.addMenuFunction('geSprite-bottom', mxResources.get('bottomAlign'), false, function() { graph.alignCells(mxConstants.ALIGN_BOTTOM); });
