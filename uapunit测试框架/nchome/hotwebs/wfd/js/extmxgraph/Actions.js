...
Actions.prototype.init = function()
{
	...
	this.addAction('openFile', function()
	{
		window.openNew = true;
		window.openKey = 'open';
	...
	this.addAction('saveFile', function() { ui.saveFile(false); }, true, null, 'Ctrl+S');
	this.addAction('saveAsFile', function() { ui.saveFile(true); }, true, null, 'Ctrl+Shift-S');
	this.addAction('saveAndDeploy', function() { ui.saveAndDeploy(false); }, true, null, 'Ctrl+Shift-D');
