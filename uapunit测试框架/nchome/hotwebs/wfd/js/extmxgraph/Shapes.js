...
(function()
{
	...
	AnnotationShape.prototype = new mxCylinder();
	AnnotationShape.prototype.constructor = AnnotationShape;
	AnnotationShape.prototype.size = 20;
	AnnotationShape.prototype.redrawPath = function(path, x, y, w, h, isForeground)
	{
	...
	gateWayShape.prototype = new mxRhombus();
	gateWayShape.prototype.constructor = gateWayShape;
	gateWayShape.prototype.size = 20;
	mxCellRenderer.prototype.defaultShapes['gateway'] = gateWayShape;
	
	/* function TaskShape() { };
	TaskShape.prototype = new mxCylinder();
	TaskShape.prototype.constructor = AnnotationShape;
	TaskShape.prototype.tabWidth = 60;
	TaskShape.prototype.tabHeight = 40;
	TaskShape.prototype.size = 30;
	TaskShape.prototype.redrawPath = function(path, x, y, w, h, isForeground)
	{
		var s = Math.min(w, Math.min(h, mxUtils.getValue(this.style, 'size', this.size) * this.scale));
			path.moveTo(w, 0);
			path.lineTo(0, 0);
	...
	mxCellRenderer.prototype.defaultShapes['task'] = TaskShape;*/
	...
	function SubProcessShape() { };
	SubProcessShape.prototype = new mxLabel();
	SubProcessShape.prototype.constructor = SubProcessShape;
	SubProcessShape.prototype.size = 30;
	mxCellRenderer.prototype.defaultShapes['subprocess'] = SubProcessShape;
	...
	mxCellRenderer.prototype.defaultShapes['dataObject'] = NoteShape;
	...
	mxCellRenderer.prototype.defaultShapes['intermediaEvent'] = StateShape;

	function StartStateShape() { };
	StartStateShape.prototype = new mxEllipse();
	StartStateShape.prototype.constructor = StartStateShape;
	StartStateShape.prototype.outerStroke = false;
	
	mxCellRenderer.prototype.defaultShapes['event'] = StartStateShape;
