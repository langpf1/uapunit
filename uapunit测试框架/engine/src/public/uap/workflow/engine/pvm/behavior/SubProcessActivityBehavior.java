 ...
 */
package uap.workflow.engine.pvm.behavior;
 ...
 * @author Tom Baeyens
 */
public interface SubProcessActivityBehavior extends CompositeActivityBehavior {
	/**
	 ...
	 */
	void completing(IActivityInstance execution, IActivityInstance subProcessInstance) throws Exception;
	/**
	 * called after the process instance is destroyed for this activity to
	 * perform its outgoing control flow logic.
	 */
	void completed(IActivityInstance execution) throws Exception;
}
