...
package uap.workflow.engine.delegate;


import uap.workflow.engine.bpmn.parser.Error;
 ...
 * @author Falko Menge
 */
public class BpmnError extends WorkflowException {
  ...
  protected void setErrorCode(String errorCode) {
    if (errorCode == null) {
      throw new WorkflowException("Error Code must not be null.");
    }
    if (errorCode.length() < 1) {
      throw new WorkflowException("Error Code must not be empty.");
    }
