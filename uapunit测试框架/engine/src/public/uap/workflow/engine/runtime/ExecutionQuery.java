 ...
 */
package uap.workflow.engine.runtime;
import java.io.Serializable;

import uap.workflow.engine.core.IProcessInstance;
import uap.workflow.engine.query.Query;
 ...
 */
public interface ExecutionQuery extends Query<ExecutionQuery, IProcessInstance> {
	...
	/**
	 * Only select executions which have a variable with the given value. The
	 * type of variable is determined based on the value, using types configured
	 * in {@link ProcessEngineConfiguration#getVariableTypes()}. Byte-arrays and
	 ...
	 * with a different value than the passed value. Byte-arrays and
	 * {@link Serializable} objects (which are not primitive type wrappers) are
	 * not supported.
	 * 
	 * @param name
	...
	/**
	 * Only select executions which have a variable value greater than the
	...
	/**
	 * Only select executions which have a variable value greater than or equal
	 * to the passed value. Booleans, Byte-arrays and {@link Serializable}
	...
	/**
	 * Only select executions which have a variable value less than the passed
	 * value. Booleans, Byte-arrays and {@link Serializable} objects (which are
	...
	/**
	 * Only select executions which have a variable value less than or equal to
