 ...
 * @author Falko Menge
 */
public interface ProcessInstanceQuery extends Query<ProcessInstanceQuery, IProcessInstance> {
	...
	/**
	 * Only select process instances which have a variable with the given value.
	...
	/**
	 * Only select process instances which have a variable value greater than or
	...
	/**
	 * Only select process instances which have a variable value less than the
	...
	/**
	 * Only select process instances which have a variable value less than or
	 * equal to the passed value. Booleans, Byte-arrays and {@link Serializable}
	 * objects (which are not primitive type wrappers) are not supported.
	 * 
	 * @param name
	...
	/**
	 * Only select process instances which have a variable value like the given
	...
	/**
	 * Only selects process instances which are active, which means that neither
