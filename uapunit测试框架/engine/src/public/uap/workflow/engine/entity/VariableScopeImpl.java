 ...
 * @author Joram Barrez
 */
public abstract class VariableScopeImpl extends AbstractObservable implements VariableScope {
	...
	public Map<String, Object> collectVariables(HashMap<String, Object> variables) {
		ensureVariableInstancesInitialized();
	...
	public void createVariableLocal(String variableName, Object value) {
		...
		if (variableInstances.containsKey(variableName)) {
			throw new WorkflowException("variable '" + variableName + "' already exists. Use setVariableLocal if you want to overwrite the value");
		}
		VariableTypes variableTypes = ((ProcessEngineConfigurationImpl) BizProcessServer.processEngineConfig).getVariableTypes();
