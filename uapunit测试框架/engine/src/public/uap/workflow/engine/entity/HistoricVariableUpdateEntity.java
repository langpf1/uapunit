...
import uap.workflow.engine.history.HistoricVariableUpdate;
...
public class HistoricVariableUpdateEntity extends HistoricDetailEntity implements ValueFields, HistoricVariableUpdate, PersistentObject {
	...
	public void delete() {
		...
		if (byteArrayValueId != null) {
			...
			// cache, but should be checked and docced here (or removed if it
	...
	public Object getPersistentState() {
		// HistoricVariableUpdateEntity is immutable, so always the same object
		// is returned
