...
public class DefaultFormHandler implements FormHandler {
	...
	public void parseConfiguration(Element activityElement, DeploymentEntity deployment, IProcessDefinition processDefinition, BpmnParse bpmnParse) {
		...
		if (extensionElement != null) {
			...
			List<Element> formPropertyElements = extensionElement.elementsNS(NameSpaceConst.BIZEX_URL, "formProperty");
	...
	protected void initializeFormProperties(FormDataImpl formData, IActivityInstance execution) {
	...
	public void submitFormProperties(Map<String, String> properties, IActivityInstance execution) {
