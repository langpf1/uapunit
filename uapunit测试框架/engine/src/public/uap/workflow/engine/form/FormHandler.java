...
public interface FormHandler {
	...
	void parseConfiguration(Element activityElement, DeploymentEntity deployment, IProcessDefinition processDefinition, BpmnParse bpmnParse);
	void submitFormProperties(Map<String, String> properties, IActivityInstance execution);
}
