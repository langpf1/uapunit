...
public class ProcessDiagramCanvas {
   ...
   * 
   * Throws an {@link WorkflowException} when {@link #close()} is already
   * called.
   */
  public InputStream generateImage(String imageType) {
    if (closed) {
      throw new WorkflowException("ProcessDiagramGenerator already closed");
    }
    ...
    try {
      ...
      throw new WorkflowException("Error while generating process image", e);
    } finally {
