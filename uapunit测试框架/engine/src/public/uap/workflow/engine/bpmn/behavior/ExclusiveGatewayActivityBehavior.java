    ...
    if (outgoingSeqFlow != null) {
      ...
      if (defaultSequenceFlow != null) {
        ...
        if (defaultTransition != null) {
          ...
          throw new WorkflowException("Default sequence flow '" + defaultSequenceFlow + "' not found");
        }
      } else {
        //No sequence flow could be found, not even a default one
        throw new WorkflowException("No outgoing sequence flow of the exclusive gateway '"
