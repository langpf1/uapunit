...
public class CompensateEndEventActivityBehavior  extends  FlowNodeActivityBehavior {
	protected  CompensateEventDefinition  compensateEventDefinition;
	public CompensateEndEventActivityBehavior(String activityReference) {
	     this.compensateEventDefinition= new CompensateEventDefinition(activityReference);          
	}
	@Override
	public void execute(IActivityInstance execution) throws Exception {
		       executeCatch(compensateEventDefinition.getActivityRef(), execution);
	}
