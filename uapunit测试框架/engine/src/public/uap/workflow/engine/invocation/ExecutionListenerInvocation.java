...
public class ExecutionListenerInvocation extends DelegateInvocation {
  ...
  protected final IInstanceListener executionListenerInstance;
  protected final IActivityInstance execution;

  public ExecutionListenerInvocation(IInstanceListener executionListenerInstance, IActivityInstance execution) {
