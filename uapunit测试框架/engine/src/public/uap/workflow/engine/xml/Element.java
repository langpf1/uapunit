...
public class Element {
	...
	public Element elementNS(String nameSpaceUri, String tagName) {
		...
		if (elements.size() == 0) {
			...
			throw new WorkflowException("Parsing exception: multiple elements with tag name " + tagName + " found");
		}
	 ...
	 * are not processed at once. So instead of a setText operation, we need to
	 * have an appendText operation.
	 */
