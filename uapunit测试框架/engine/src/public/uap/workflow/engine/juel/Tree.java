...
/**
 * Parsed expression, usually created by a {@link uap.workflow.engine.juel.TreeBuilder}.
 * The {@link #bind(FunctionMapper, VariableMapper)} method is used to create
 * {@link uap.workflow.engine.juel.Bindings}, which are needed at evaluation time to
