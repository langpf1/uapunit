...
import uap.workflow.engine.calendar.BusinessCalendar;
...
public class TimerDeclarationImpl implements Serializable {
	...
	public TimerEntity prepareTimerEntity(ActivityInstanceEntity executionEntity) {
		...
		if (description == null) {
			throw new WorkflowException("Timer '" + executionEntity.getActivity().getId() + "' was not configured with a valid duration/time");
		}
