 ...
 */
package uap.workflow.engine.util;
...
import uap.workflow.engine.exception.WorkflowClassLoadingException;
...
public abstract class ReflectUtil {
	...
	public static Class<?> loadClass(String className) {
		...
		if (clazz == null) {
			throw new WorkflowClassLoadingException(className, throwable);
		}
		return clazz;
	}
	...
	public static Object instantiate(String className) {
		try {
			...
			throw new WorkflowException("couldn't instantiate class " + className, e);
		}
	}
	public static Object invoke(Object target, String methodName, Object[] args) {
		try {
			...
			throw new WorkflowException("couldn't invoke " + methodName + " on " + target, e);
		}
	}
	/**
	...
	public static Field getField(String fieldName, Class<?> clazz) {
		...
		try {
			...
			throw new WorkflowException("not allowed to access field " + field + " on class " + clazz.getCanonicalName());
	...
	public static void setField(Field field, Object object, Object value) {
		try {
			...
			throw new WorkflowException("Could not set field " + field.toString(), e);
	...
	public static Method getSetter(String fieldName, Class<?> clazz, Class<?> fieldType) {
		...
		try {
			...
			throw new WorkflowException("Not allowed to access method " + setterName + " on class " + clazz.getCanonicalName());
		}
	}
	...
	public static Object instantiate(String className, Object[] args) {
		...
		if (constructor == null) {
			throw new WorkflowException("couldn't find constructor for " + className + " with args " + Arrays.asList(args));
		}
		try {
			return constructor.newInstance(args);
		} catch (Exception e) {
			throw new WorkflowException("couldn't find constructor for " + className + " with args " + Arrays.asList(args), e);
		}
	}
	...
	private static ClassLoader getCustomClassLoader() {
		ProcessEngineConfigurationImpl processEngineConfiguration = BizProcessServer.getProcessEngineConfig();
