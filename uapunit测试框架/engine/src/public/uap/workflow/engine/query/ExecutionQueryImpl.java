 ...
 * @author Daniel Meyer
 */
public class ExecutionQueryImpl extends ExecutionVariableQueryImpl<ExecutionQuery, IProcessInstance> implements ExecutionQuery {
	...
	public ExecutionQueryImpl executionId(String executionId) {
		if (executionId == null) {
			throw new WorkflowException("Execution id is null");
		}
