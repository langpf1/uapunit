 ...
 * @author Tom Baeyens
 */
public class TaskQueryImpl extends AbstractQuery<TaskQuery, ITask> implements TaskQuery {
	...
	public TaskQueryImpl taskId(String taskId) {
		if (taskId == null) {
			throw new WorkflowException("Task id is null");
		}
		this.taskId = taskId;
		return this;
	}
	...
	public TaskQueryImpl taskNameLike(String nameLike) {
		if (nameLike == null) {
			throw new WorkflowException("Task namelike is null");
		}
	...
	public TaskQueryImpl taskDescription(String description) {
		if (description == null) {
			throw new WorkflowException("Description is null");
		}
	...
	public TaskQuery taskDescriptionLike(String descriptionLike) {
		if (descriptionLike == null) {
			throw new WorkflowException("Task descriptionlike is null");
		}
	...
	public TaskQuery taskPriority(Integer priority) {
		if (priority == null) {
			throw new WorkflowException("Priority is null");
		}
	...
	public TaskQuery taskMinPriority(Integer minPriority) {
		if (minPriority == null) {
			throw new WorkflowException("Min Priority is null");
		}
	...
	public TaskQuery taskMaxPriority(Integer maxPriority) {
		if (maxPriority == null) {
			throw new WorkflowException("Max Priority is null");
		}
	...
	public TaskQueryImpl taskAssignee(String assignee) {
		if (assignee == null) {
			throw new WorkflowException("Assignee is null");
		}
	...
	public TaskQueryImpl taskOwner(String owner) {
		if (owner == null) {
			throw new WorkflowException("Owner is null");
		}
		this.owner = owner;
		return this;
	}
	...
	public TaskQueryImpl taskCandidateUser(String candidateUser) {
		if (candidateUser == null) {
			throw new WorkflowException("Candidate user is null");
		}
		if (candidateGroup != null) {
			throw new WorkflowException("Invalid query usage: cannot set both candidateUser and candidateGroup");
		}
		if (candidateGroups != null) {
			throw new WorkflowException("Invalid query usage: cannot set both candidateUser and candidateGroupIn");
		}
	...
	public TaskQueryImpl taskInvolvedUser(String involvedUser) {
		if (involvedUser == null) {
			throw new WorkflowException("Involved user is null");
		}
	...
	public TaskQueryImpl taskCandidateGroup(String candidateGroup) {
		if (candidateGroup == null) {
			throw new WorkflowException("Candidate group is null");
		}
		if (candidateUser != null) {
			throw new WorkflowException("Invalid query usage: cannot set both candidateGroup and candidateUser");
		}
		if (candidateGroups != null) {
			throw new WorkflowException("Invalid query usage: cannot set both candidateGroup and candidateGroupIn");
		}
	...
	public TaskQuery taskCandidateGroupIn(List<String> candidateGroups) {
		if (candidateGroups == null) {
			throw new WorkflowException("Candidate group list is null");
		}
		if (candidateGroups.size() == 0) {
			throw new WorkflowException("Candidate group list is empty");
		}
		if (candidateUser != null) {
			throw new WorkflowException("Invalid query usage: cannot set both candidateGroupIn and candidateUser");
		}
		if (candidateGroup != null) {
			throw new WorkflowException("Invalid query usage: cannot set both candidateGroupIn and candidateGroup");
		}
	...
	// results ////////////////////////////////////////////////////////////////
	public List<ITask> executeList(CommandContext commandContext, Page page) {
