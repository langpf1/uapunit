 ...
 * @author Daniel Meyer
 */
public class ProcessDefinitionQueryImpl extends AbstractQuery<ProcessDefinitionQuery, IProcessDefinition> implements ProcessDefinitionQuery {
	...
	public ProcessDefinitionQueryImpl processDefinitionCategory(String category) {
		if (category == null) {
			throw new WorkflowException("category is null");
		}
	...
	public ProcessDefinitionQueryImpl processDefinitionCategoryLike(String categoryLike) {
		if (categoryLike == null) {
			throw new WorkflowException("categoryLike is null");
		}
	...
	public ProcessDefinitionQueryImpl processDefinitionName(String name) {
		if (name == null) {
			throw new WorkflowException("name is null");
		}
		this.name = name;
		return this;
	}
	public ProcessDefinitionQueryImpl processDefinitionNameLike(String nameLike) {
		if (nameLike == null) {
			throw new WorkflowException("nameLike is null");
		}
	...
	public ProcessDefinitionQueryImpl deploymentId(String deploymentId) {
		if (deploymentId == null) {
			throw new WorkflowException("id is null");
		}
	...
	public ProcessDefinitionQueryImpl processDefinitionKey(String key) {
		if (key == null) {
			throw new WorkflowException("key is null");
		}
		this.key = key;
		return this;
	}
	public ProcessDefinitionQueryImpl processDefinitionKeyLike(String keyLike) {
		if (keyLike == null) {
			throw new WorkflowException("keyLike is null");
		}
	...
	public ProcessDefinitionQueryImpl processDefinitionResourceName(String resourceName) {
		if (resourceName == null) {
			throw new WorkflowException("resourceName is null");
		}
	...
	public ProcessDefinitionQueryImpl processDefinitionResourceNameLike(String resourceNameLike) {
		if (resourceNameLike == null) {
			throw new WorkflowException("resourceNameLike is null");
		}
	...
	public ProcessDefinitionQueryImpl processDefinitionVersion(Integer version) {
		if (version == null) {
			throw new WorkflowException("version is null");
		} else if (version <= 0) {
			throw new WorkflowException("version must be positive");
		}
	...
	public ProcessDefinitionQuery eventSubscription(String eventType, String eventName) {
		if (eventName == null) {
			throw new WorkflowException("event name is null");
		}
		if (eventType == null) {
			throw new WorkflowException("event type is null");
		}
	...
	public List<IProcessDefinition> executeList(CommandContext commandContext, Page page) {
		checkQueryOk();
	...
	public void checkQueryOk() {
		...
		if (latest && ((id != null) || (name != null) || (nameLike != null) || (version != null) || (deploymentId != null))) {
			throw new WorkflowException("Calling latest() can only be used in combination with key(String) and keyLike(String)");
		}
	}
	// getters ////////////////////////////////////////////
