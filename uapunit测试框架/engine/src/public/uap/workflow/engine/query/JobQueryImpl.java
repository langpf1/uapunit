...
public class JobQueryImpl extends AbstractQuery<JobQuery, Job> implements JobQuery, Serializable {
  ...
  public JobQuery jobId(String jobId) {
    if (jobId == null) {
      throw new WorkflowException("Provided job id is null");
    }
    this.id = jobId;
    return this;
  }
  ...
  public JobQueryImpl processInstanceId(String processInstanceId) {
    if (processInstanceId == null) {
      throw new WorkflowException("Provided process instance id is null");
    }
  ...
  public JobQueryImpl executionId(String executionId) {
    if (executionId == null) {
      throw new WorkflowException("Provided execution id is null");
    }
  ...
  public JobQuery timers() {
    if (onlyMessages) {
      throw new WorkflowException("Cannot combine onlyTimers() with onlyMessages() in the same query");
    }
  ...
  public JobQuery duedateHigherThen(Date date) {
    if (date == null) {
      throw new WorkflowException("Provided date is null");
    }
  ...
  public JobQuery exceptionMessage(String exceptionMessage) {
    if (exceptionMessage == null) {
      throw new WorkflowException("Provided exception message is null");
    }
