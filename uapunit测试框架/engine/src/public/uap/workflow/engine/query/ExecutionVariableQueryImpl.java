...
public abstract class ExecutionVariableQueryImpl<T extends Query<?,?>, U> extends AbstractQuery<T, U> {
  ...
  private void addVariable(String name, Object value, QueryOperator operator) {
    ...
    if(value == null || isBoolean(value)) {
      ...
      switch(operator) {
      case GREATER_THAN:
        throw new WorkflowException("Booleans and null cannot be used in 'greater than' condition");
      case LESS_THAN:
        throw new WorkflowException("Booleans and null cannot be used in 'less than' condition");
      case GREATER_THAN_OR_EQUAL:
        throw new WorkflowException("Booleans and null cannot be used in 'greater than or equal' condition");
      case LESS_THAN_OR_EQUAL:
        throw new WorkflowException("Booleans and null cannot be used in 'less than or equal' condition");
      case LIKE:
        throw new WorkflowException("Booleans and null cannot be used in 'like' condition");
      }
    }
