...
public class HistoricProcessInstanceQueryImpl extends AbstractQuery<HistoricProcessInstanceQuery, HistoricProcessInstance> implements HistoricProcessInstanceQuery {
	...
	/*
	 * public HistoricProcessInstanceQuery processVariableEquals(String
	 * variableName, Object variableValue) { variables.add(new
	 * QueryVariableValue(variableName, variableValue, QueryOperator.EQUALS));
	 * return this; }
	 */
	...
	public long executeCount(CommandContext commandContext) {
		...
		return commandContext.getProcessInstanceManager().findHistoricProcessInstanceCountByQueryCriteria(this);
	}
	public List<HistoricProcessInstance> executeList(CommandContext commandContext, Page page) {
		checkQueryOk();
		ensureVariablesInitialized();
		return commandContext.getProcessInstanceManager().findHistoricProcessInstancesByQueryCriteria(this, page);
	}
