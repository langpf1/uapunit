...
public class GetStartFormCmd implements Command<StartFormData>, Serializable {
	...
	public GetStartFormCmd(String proDefPk) {
	...
	public StartFormData execute(CommandContext commandContext) {
		...
		if (processDefinition == null) {
			throw new WorkflowException("No process definition found for id '" + proDefPk + "'");
		}
		StartFormHandler startFormHandler = processDefinition.getStartFormHandler();
		if (startFormHandler == null) {
			throw new WorkflowException("No startFormHandler defined in process '" + proDefPk + "'");
		}
