...
public class DeleteHistoricProcessInstanceCmd implements Command<Object>, Serializable {
  ...
  public Object execute(CommandContext commandContext) {
    ...
    if(instance == null) {
      throw new WorkflowException("No historic process instance found with id: " + processInstanceId);
    }
    if(instance.getEndTime() == null) {
      throw new WorkflowException("Process instance is still running, cannot delete historic process instance: " + processInstanceId);
    }
