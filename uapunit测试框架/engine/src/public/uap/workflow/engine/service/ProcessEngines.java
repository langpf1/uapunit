...
import uap.workflow.engine.query.ProcessEngineInfoImpl;
...
public abstract class ProcessEngines {
  ...
  public synchronized static void init() {
    if (!isInitialized) {
      ...
      try {
        ...
        throw new WorkflowException("problem retrieving activiti.cfg.xml resources on the classpath: "+System.getProperty("java.class.path"), e);
      }
      ...
      try {
        ...
        throw new WorkflowException("problem retrieving activiti-context.xml resources on the classpath: "+System.getProperty("java.class.path"), e);
      }
      while (resources.hasMoreElements()) {
        URL resource = resources.nextElement();
  ...
  protected static void initProcessEngineFromSpringResource(URL resource) {
    try {
      ...
      throw new WorkflowException("couldn't initialize process engine from spring configuration resource "+resource.toString()+": "+e.getMessage(), e);
    } 
  }
  ...
  private static  ProcessEngine buildProcessEngine(URL resource) {
    ...
    try {
      ...
      throw new WorkflowException("couldn't open resource stream: "+e.getMessage(), e);
    } finally {
  ...
  */
  ...
  public static ProcessEngineInfo retry(String resourceUrl) {
    ...
    try {
      ...
      throw new WorkflowException("invalid url: "+resourceUrl, e);
    }
  }
