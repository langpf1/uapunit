...
public interface RuntimeService {
	 ...
	 */
	IProcessInstance startProcessInstanceByKey(String proDefPk);
	/**
	 * Starts a new process instance in the latest version of the process
	 * definition with the given key.
	 * 
	 ...
	 * can then be used to easily look up that process instance , see Providing
	 ...
	 *             when no process definition is deployed with the given key.
	 */
	IProcessInstance startProcessInstanceByKey(String proDefPk, Map<String, Object> variables);
	/**
	 * Starts a new process instance in the latest version of the process
	 * definition with the given key.
	 * 
	 ...
	 *             when no process definition is deployed with the given key.
	 */
	IProcessInstance startProcessInstanceById(String proDefId);
	/**
	 * Starts a new process instance in the exactly specified version of the
	 * process definition with the given id.
	 * 
	 ...
	 *             when no process definition is deployed with the given key.
	 */
	IProcessInstance startProcessInstanceById(String processDefinitionId, Map<String, Object> variables);
	/**
	 * Starts a new process instance in the exactly specified version of the
	 * process definition with the given id.
	 * 
	 ...
	 * {@link WorkflowException} is thrown</li>
	 * </ul>
	 * </p>
	 * 
	 * @param messageName
	 ...
	 * @since 5.9
	 */
	IProcessInstance startProcessInstanceByMessage(String messageName, Map<String, Object> processVariables);
	/**
	 * <p>
	 * Signals the process engine that a message is received and starts a new
	 * {@link ProcessInstance}.
	...
	/**
	 * Update or create a variable for an execution. If the variable is not
	 * already existing somewhere in the execution hierarchy, it will be created
	 * in the process instance (which is the root execution).
	 * 
	 * @param executionId
	 ...
	 * scopes). If the variables are not already existing, they will be created
	 * in the process instance (which is the root execution).
	 * 
	 * @param executionId
	 *            id of the execution, cannot be null.
	 ...
	 * 
	 * @throws WorkflowException
	 *             if no such processInstance can be found or if the process
	 *             instance is already in state suspended.
	 */
	 ...
	 * @throws WorkflowException
	 *             if no such processInstance can be found or if the process
	 *             instance is already in state active.
	 */
	 ...
	 * @throws WorkflowException
	 *             if no such execution exists or if the execution has not
