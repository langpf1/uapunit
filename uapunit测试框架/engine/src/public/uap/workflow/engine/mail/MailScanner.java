  ...
  public void shutdown() {
    ...
    try {
      threadPoolExecutor.awaitTermination(60L, TimeUnit.SECONDS);
        ...
        throw new WorkflowException("Timeout during shutdown of mail scanner. The current running scans could not end withing 60 seconds after shutdown operation.", e);
    }
