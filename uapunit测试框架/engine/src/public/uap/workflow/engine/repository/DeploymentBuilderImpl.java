 ...
 */
package uap.workflow.engine.repository;
...
public class DeploymentBuilderImpl implements DeploymentBuilder, Serializable {
	...
	public DeploymentBuilder addInputStream(String resourceName, InputStream inputStream) {
		if (inputStream == null) {
			throw new WorkflowException("inputStream for resource '" + resourceName + "' is null");
		}
	...
	public DeploymentBuilder addClasspathResource(String resource) {
		...
		if (inputStream == null) {
			throw new WorkflowException("resource '" + resource + "' not found");
		}
		return addInputStream(resource, inputStream);
	}
	public DeploymentBuilder addString(String resourceName, String text) {
		if (text == null) {
			throw new WorkflowException("text is null");
		}
		ResourceEntity resource = new ResourceEntity();
		resource.setName(resourceName);
	...
	public DeploymentBuilder addZipInputStream(ZipInputStream zipInputStream) {
		try {
			...
			throw new WorkflowException("problem reading zip input stream", e);
		}
		return this;
	}
