...
public class VariableScopeElResolver extends ELResolver {
	...
	public Object getValue(ELContext context, Object base, Object property) {
		if (base == null) {
			...
			if ((EXECUTION_KEY.equals(property) && variableScope instanceof IActivityInstance) || (TASK_KEY.equals(property) && variableScope instanceof ITask)) {
				context.setPropertyResolved(true);
				return variableScope;
			} else if (EXECUTION_KEY.equals(property) && variableScope instanceof ITask) {
				context.setPropertyResolved(true);
				return ((ITask) variableScope).getExecution();
