 ...
 * </p>
 * 
 * <p>The activitiRule also lets you {@link WorkflowRule#setCurrentTime(Date) set the current time used by the 
 ...
 * @author Tom Baeyens
 */
public class WorkflowRule extends TestWatchman {
  ...
  public WorkflowRule(String configurationResource) {
    this.configurationResource = configurationResource;
  }
  
  public WorkflowRule(ProcessEngine processEngine) {
