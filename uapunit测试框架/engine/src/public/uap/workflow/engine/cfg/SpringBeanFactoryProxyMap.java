...
public class SpringBeanFactoryProxyMap implements Map<Object, Object> {
  ...
  public Set<Object> keySet() {
    throw new WorkflowException("unsupported operation on configuration beans");
//    List<String> beanNames = Arrays.asList(beanFactory.getBeanDefinitionNames());
//    return new HashSet<Object>(beanNames);
  }

  public void clear() {
    throw new WorkflowException("can't clear configuration beans");
  }

  public boolean containsValue(Object value) {
    throw new WorkflowException("can't search values in configuration beans");
  }
