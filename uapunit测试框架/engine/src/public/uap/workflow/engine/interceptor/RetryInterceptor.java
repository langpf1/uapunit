...
/**
 * Intercepts {@link WorkflowOptimisticLockingException} and tries to run the
...
public class RetryInterceptor extends CommandInterceptor {
  ...
  public <T> T execute(Command<T> command) {
    ...
    do {      
      ...
      } catch (WorkflowOptimisticLockingException e) {
    ...
    throw new WorkflowException(numOfRetries + " retries failed with ActivitiOptimisticLockingException. Giving up.");
  }
