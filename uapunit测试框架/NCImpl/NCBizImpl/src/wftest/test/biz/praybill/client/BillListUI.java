...
public class BillListUI extends UIDialog {
	...
	private void initializeData(){
		try {
			AggTestPrayBill[] pos = NCLocator.getInstance().lookup(IServicesInterface.class).getPrayBill();
			List<String> items = new ArrayList<String>();
			TestPrayBillMaster master = null;
			for(AggTestPrayBill bill : pos){
				master = (TestPrayBillMaster)bill.getParentVO();
