...
public class BillListUI extends UIDialog {
	...
	private void initializeData(){
		try {
			AggTestRcvBill[] pos = NCLocator.getInstance().lookup(IServicesInterface.class).getPO();
			List<String> items = new ArrayList<String>();
			TestRcvBillMaster master = null;
			for(AggTestRcvBill bill : pos){
				master = (TestRcvBillMaster)bill.getParentVO();
